...
def generate_regex_from_sample(sample: str) -> str:
    ...
    # Replace numbers with a generic digit matcher
...
class ReviewWindow(tk.Toplevel):
    ...
    def __init__(self, parent, pattern_name: str, pattern_label: str, file_info: dict = None):
        ...
        # --- UI Element Creation (all widgets created before configuration) ---
    ...
    #==============================================================
    # --- MODIFIED: The entire save logic is now unified and robust ---
    #==============================================================
    def save_patterns_to_config(self):
        ...
        try:
            ...
            try:
                ...
                pass # It's fine if the file or other lists don't exist yet
            ...
            for name, patterns in all_lists_to_save.items():
                ...
                for pattern in patterns:
                    # Safely escape any single quotes in the pattern string
